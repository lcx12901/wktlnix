{
  ...
  # https://github.com/AstroNvim/AstroNvim/blob/v4.27.2/lua/astronvim/plugins/_astroui_status.lua#L66
  modes.__raw = ''
    {
      ["n"] = { "NORMAL", "normal" },
      ["no"] = { "OP", "normal" },
  ...
  # https://github.com/AstroNvim/AstroNvim/blob/v4.27.2/lua/astronvim/plugins/_astroui_status.lua#L111
  attributes = {
    buffer_active = {
      bold = true;
      italic = true;
  ...
  # https://github.com/AstroNvim/AstroNvim/blob/v4.27.2/lua/astronvim/plugins/_astroui_status.lua#L13
  sign_handlers.__raw = ''
    (function()
      local sign_handlers = {}
      -- gitsigns handlers
  ...
  # https://github.com/AstroNvim/AstroNvim/blob/v4.27.2/lua/astronvim/plugins/_astroui_status.lua#L126
  setup_colors.__raw = ''
    function()
  ...
  extraPlugins = [
    (pkgs.vimUtils.buildVimPlugin {
      ...
      src = pkgs.fetchFromGitHub {
        ...
        repo = "astroui";
        rev = "v${version}";
        hash = "sha256-gOfpH9YEBSRuEGha/kjkxCpFehB3AtEXD/p7ZASfrrg=";
      };
    })
  ];
